...
const Home = () => {
	...
	const [selectedMachine, setSelectedMachine] = useState(null) // faqat bitta mashina
	...
	const handleBooking = async e => {
		...
		try {
			const bookingData = {
				...
				machine_ids: [selectedMachine], // backend array kutadi
			...
			console.error(err)
			// Serverdan kelgan aniq xabarni chiqarish
			const errorMessage =
